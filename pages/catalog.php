...
<div class="container">
    ...
    <div class="page-header">
        <div class="breadcrumbs">
            Главная → Каталог → Запчасти для вертолетов
        </div>
            ...
            <div class="catalog-grid">
                ...
                <article class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <a class="btn-primary" style="text-decoration: none;color: white;text-align: center" href="/pages/detail/product.php">Посмотреть</a>
                    </div>
                </article>
